											...
											<%-- <form id="loginAction_home" name="form1" action="${pageContext.request.contextPath}/login/home.jsp" target="_parent" method="post"> --%>
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<td>
															<s:textfield name="loginName" id="logonName" cssClass="text" cssStyle="width: 160px;"/>
														</td>
													</tr>
													<tr>
														<td height="30" nowrap>
														...
														<td>
															<s:password name="loginPwd" id="logonPwd" cssClass="text" cssStyle="width: 160px;"/>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
															<s:submit value="登陆" cssClass="buttoninput"/>
															
															<s:reset value="重置" cssClass="buttoninput"/>
